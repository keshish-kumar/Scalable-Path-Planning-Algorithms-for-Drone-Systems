...
def save_test_case_to_file(distance_matrix, weights, filename="test_case_15_nodes.txt"):
...
# Parameters
num_nodes = 15  # 15 nodes (including depot)
...
print("Test case saved to 'test_case_15_nodes.txt'.")
