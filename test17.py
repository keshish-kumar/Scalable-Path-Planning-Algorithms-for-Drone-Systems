...
def save_test_case_to_file(distance_matrix, weights, filename="test_case_17_nodes.txt"):
...
# Parameters
num_nodes = 17  # 10 nodes (including depot)
...
print("Test case saved to 'test_case_17_nodes.txt'.")
